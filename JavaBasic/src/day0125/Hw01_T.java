    ...
    public static void main(String []args) {
        ...
        while(true) {
            ...
            if(userChoice == 1) {
                ...
                while(userSelect < INT_SISSOR || userSelect > INT_PAPER) {
                ...
                if(userSelect == computerSelect) {
                    ...
                    if((userSelect == INT_ROCK && computerSelect == INT_PAPER) ||
                            (userSelect == INT_SISSOR && computerSelect == INT_ROCK) ||
                            (userSelect == INT_PAPER && computerSelect == INT_SISSOR )) {
                        result = INT_LOSE;
                    }else {
                        result = INT_WIN;
                    }
